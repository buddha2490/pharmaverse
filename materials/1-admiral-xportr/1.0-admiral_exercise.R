...
src_ae <- dthcaus_source(
  dataset_name = "ae",
  filter = AEOUT == "FATAL", # wrapper for dplyr::filter()
  date = convert_dtc_to_dtm(AESTDTC, highest_imputation = "M"), # convert character date to datetime
  mode = "first", # keep first or last observation
  dthcaus = AEDECOD,
